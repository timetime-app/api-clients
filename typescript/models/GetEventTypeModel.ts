...
export class GetEventTypeModel {
    'id': string;
    'slug': string;
    'fullSlug': string;
    'userId': string;
    ...
    'step': string;
    /**
    * It defines the duration of the event type. Allowed format is ISO-8601 duration, maximum unit allowed is days.
    */
    'description'?: string;
    ...
    */
    ...
    static getAttributeTypeMap() {
        return GetEventTypeModel.attributeTypeMap;
    }
